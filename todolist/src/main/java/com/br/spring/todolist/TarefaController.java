...
public class TarefaController {
    ...
    @PatchMapping(path = "tarefa/{id}/marcar-feita", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PatchMapping(path = "tarefa/{id}/marcar-pendente", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PatchMapping(path = "tarefa/{id}/{projeto_id}", produces = MediaType.APPLICATION_JSON_VALUE)
    public Tarefa vincularProjeto(@PathVariable("id") Long id, @PathVariable("projeto_id") Long projeto ) {
